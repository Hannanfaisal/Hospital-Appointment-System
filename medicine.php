    ...
    <section class="contact-img">
      <div class="row">
        <div class="col-md-4">
          ...
          <p>
            <a href="index.html">Home</a> > General Medicine
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container mb-5">
        <div class="row department-category-img-container mx-1 mt-5 mb-5">
          <div class="col-lg-6 p-4 col-12">
            <h2>About Our Medicine Department</h2>
            <p class="text-wrap" style="text-align: justify;">
              Our Medine Department is providing expert services 24/7 to
              ...
              facilite and practice general medicine. It deals with all kinds of diagnoisis 
              essential for any disease.
        ...
        <h2 class="text-center mb-4">Our Medicine Doctors</h2>
        <div class="row">

        
        <?php

        $query = "SELECT * FROM doctors WHERE department = 'General Medicine'";
