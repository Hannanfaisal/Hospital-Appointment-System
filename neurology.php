    ...
    <section class="contact-img">
      <div class="row">
        <div class="col-md-4">
          <h1>NEUROLOGY</h1>
          <p>
            <a href="index.html">Home</a> > Neurology
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container mb-5">
        <div class="row department-category-img-container mx-1 mt-5 mb-5">
          <div class="col-lg-6 p-4 col-12">
            <h2>About Our Neuro Department</h2>
            <p class="text-wrap" style="text-align: justify;">
              Our Neurology Department is providing expert services 24/7 to
              ...
              treat brain conditions. We are treating hundreds of patients through efficient surgery
              procedures of the brain system.
        ...
        <h2 class="text-center mb-4">Our Neurology Doctors</h2>
        <div class="row">

          
        <?php

$query = "SELECT * FROM doctors WHERE department = 'Neurology'";
