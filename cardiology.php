  ...
  <section class="contact-img">
    <div class="row">
      <div class="col-md-4">
        <h1>CARDIOLOGY</h1>
        <p>
          <a href="index.html">Home</a> > Cardiology
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="container mb-5">
      <div class="row department-category-img-container mx-1 mt-5 mb-5">
        <div class="col-lg-6 p-4 col-12">
          <h2>About Our Cardic Department</h2>
          <p class="text-wrap" style="text-align: justify;">
            Our Cardiology Department is providing expert services 24/7 to
            ...
            treat Heart diseases and heart attack conditions. We are treating hundreds of patients through efficient surgery
            procedures of heart.
        ...
        <div class="col-lg-6 p-5 col-12">
          ...
          <div class="border rounded-4 p-4  text-center" style="background-color: rgb(42, 42, 84)">
            <img class="img-fluid " src="images/heart.png" height="150px" width="150px" alt="" style="border-radius: 30px" />
          </div>

        </div>
      </div>
      <h2 class="text-center mb-4">Our Cardiology Doctors</h2>
      <div class="row">

        <?php

        $query = "SELECT * FROM doctors WHERE department = 'Cardiology'";
